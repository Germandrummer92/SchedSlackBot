...
def test_execute_unscheduled_reminder(scheduler: ReminderScheduler, reminder: Reminder,
                                      reminder_sender: mock.MagicMock) -> None:
...
def test_schedule_all_remindesr(scheduler: ReminderScheduler, reminder: Reminder, schedule: Schedule,
                                reminder_sender: mock.MagicMock) -> None:
...
def test_stop_reminder(scheduler: ReminderScheduler, reminder: Reminder, schedule: Schedule,
                       reminder_sender: mock.MagicMock) -> None:
    scheduler.schedule_reminder(schedule=schedule, reminder_sender=reminder_sender)
