...
def test_send_reminder(slack_sender: SlackReminderSender, client: mock.MagicMock, reminder: Reminder) -> None:
...
def test_skip_reminder(slack_sender: SlackReminderSender, client: mock.MagicMock, reminder: Reminder) -> None:
